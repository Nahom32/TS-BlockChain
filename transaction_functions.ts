import { TxIn,TxOut,Transaction,UnspentTxOut } from "./Transaction";
...
const hasDuplicates = (txIns: TxIn[]): boolean => {
 ...
 const validateCoinbaseTx = (transaction: Transaction, blockIndex: number): boolean/*|null|undefined*/ => {
    if (transaction == null) {
