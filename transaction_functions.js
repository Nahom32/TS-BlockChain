...
exports.getPublicKey = exports.getCoinbaseTransaction = exports.getTransactionId = exports.signTxIn = exports.processTransactions = void 0;
...
const findUnspentTxOut = (transactionId, index, aUnspentTxOuts) => {
    ...
    if (value != null && value != undefined) {
        ...
        return new Transaction_1.UnspentTxOut('', 0, '', 0);
    }
};
const getCoinbaseTransaction = (address, blockIndex) => {
    ...
    t.txIns = [txIn];
    t.txOuts = [new Transaction_1.TxOut(address, COINBASE_AMOUNT)];
